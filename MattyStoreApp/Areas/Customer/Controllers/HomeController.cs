...
using MattyStoreApp.Models.ViewModels;
...
namespace MattyStoreApp.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cartFromDb == null)
                {
                    //No Record  exist for the user with that product  in the database
                ...
                //This is Customized Session Stored, You can always have your session Object customized to your request.
                 // HttpContext.Session.SetObject(SD.ssShoppingCart, CartObject);

                //For this project, we will Inbuit Session for Integers.
